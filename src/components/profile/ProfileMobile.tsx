...
import { ProfileMobileSkeleton } from "@/components/skeleton/PageSkeletons";
import { Skeleton } from "@/components/ui/skeleton";
import { openCrispChat } from "@/lib/analytics";

type ProfileData = ReturnType<typeof useProfilePage>;

export function ProfileMobile(profile: ProfileData) {
  const {
    isAuthenticated,
    isLoading,
    profileLoading,
      ...
      <section className={styles.accountSection}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Link to="/login" className={styles.continueBtn}>
              Continue
            </Link>
          </>
        )}

...
import styles from "@/styles/profile/addresses.module.css";
...
import { AddressesListSkeleton } from "@/components/skeleton/PageSkeletons";

export function AddressesMobile() {

...
import styles from "@/styles/profile/referral.module.css";
import { Skeleton } from "@/components/ui/skeleton";
import { ReferralTreeSkeleton } from "@/components/skeleton/PageSkeletons";
            ...
            <section className={styles.statsRow}>
              <div className={styles.statCard}>
                ...
                <span className={`${styles.statValue} ${styles.statBlue}`}>
                  {loading ? <Skeleton className="h-7 w-10" /> : totalReferrals}
                </span>
              </div>
              <div className={styles.statCard}>
                <span className={styles.statLabel}>Direct Referrals</span>
                <span className={`${styles.statValue} ${styles.statGreen}`}>
                  {loading ? <Skeleton className="h-7 w-10" /> : directReferrals}
                </span>
              </div>
            </section>

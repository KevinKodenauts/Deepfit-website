import type { useUpdateProfileForm } from "@/hooks/useUpdateProfileForm";
import { ChevronLeft, Lock, Mail, User } from "lucide-react";
import CountryPhoneField from "@/components/profile/CountryPhoneField";
import styles from "@/styles/profile/updateProfileDesktop.module.css";

type Form = ReturnType<typeof useUpdateProfileForm>;

export function UpdateProfileDesktop({ form }: { form: Form }) {
  if (!form.user) {
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.form}>
            ...
            {form.error ? <p className={styles.formError}>{form.error}</p> : null}

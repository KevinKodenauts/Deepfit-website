...
import PasswordCheckBar from "@/components/auth/PasswordCheckBar";
...
import styles from "@/styles/signup/signupDesktop.module.css";
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        {googleError ? <p className={styles.formError}>{googleError}</p> : null}
        ...
        <form className={styles.authForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.fieldGroup}>
            <PasswordGuidance htmlFor="signup-password-desktop" />
            <div className={styles.inputWrapper}>

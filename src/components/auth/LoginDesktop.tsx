...
import styles from "@/styles/login/loginDesktop.module.css";
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <button type="button" className={styles.googleBtn} disabled={!googleAvailable || googleLoading} onClick={googleSignIn}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
        ...
        {googleError && <p className={styles.formError}>{googleError}</p>}

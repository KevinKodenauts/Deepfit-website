...
import styles from "@/styles/wallet/addMoney.module.css";
            ...
            <div className={styles.noteSection}>
              ...
              <ul className={styles.noteList}>
                <li className={styles.noteItem}>
                  Deepfit Money balance is valid for 1 year from the date of money
                  added
                </li>
                <li className={styles.noteItem}>
                  Deepfit Money cannot be transferred to a bank account as per RBI
                  guidelines. <span className={styles.linkText}>Read T&amp;Cs</span>
                </li>
              </ul>
            </div>
              ...
              >
                <div className={styles.payAmount}>
                  <span className={styles.payAmountValue}>
                    <CurrencyAmount>{amount.toLocaleString()}.00</CurrencyAmount>
                  </span>

  ...
  head: () => ({
    meta: [
      { title: "About Us — DEEPFIT" },
      {
        name: "description",
        content:
          "DEEPFIT is a holistic wellness brand built on Mind, Move and Fuel — helping people feel their best for life.",
      },
      { property: "og:title", content: "About Us — DEEPFIT" },
      {
        property: "og:description",
        content:
          "Wellness Inside Out. Learn the story, founder, method and values behind DEEPFIT.",
      },
    ],
  }),
  component: AboutPage,

  ...
  head: () => ({
    meta: [
      { title: "Contact — DEEPFIT" },
      {
        name: "description",
        content:
          "Reach the Deepfit studio team for orders, shipping, returns and press.",
      },
      ...
      <section className="relative overflow-hidden bg-soft pt-32">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 lg:px-10">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-5xl leading-[1.15] sm:text-7xl">
            ...
            <span className="text-gradient italic">personally.</span>
          </h1>
        </div>
      </section>
          ...
          {[
            ...
            const body = (
              <>
                ...
                <div className="mt-1 font-display text-2xl leading-snug">
                  {c.v}
                </div>
                {"sub" in c && c.sub ? (
